...
function App() {
    ...
    // 신규 상품을 추가해야 함으로 setProducts가 이제 필요합니다.
    const [products, setProducts] = useState([
        ...
        { id: 7, name: "바닐라 마카롱", price: 2500, category: 'macaron', stock: 120, image: 'vanilla_macaron.jpg', description: "부드럽고 달콤한 바닐라 크림이 들어 있는 프랑스식 디저트입니다. 겉은 바삭하고 속은 촉촉한 식감이 특징입니다." },
    ...
    const InsertData = (formData) => {
        ...
        // newData는 사용자가 입력한 데이터를 저장하는 있는 배열입니다.
        const newData = [{
            id: newId,
    ...
    */
    ...
    const Ordering = (orderInformation) => {
        ...
        // a와 b는 상품 각각 상품 1개를 의미하는 객체 정보(java의 bean으로 봐도 무방합니다.)
        products.sort((a, b) => {
            let aValue = a[column];
            let bValue = b[column];
    ...
    return (
        <Card>
            ...
            <Card.Body>
                ...
                orderInfo={orderInfo}
                onChangeCategory={CategoryChangerd}
                />
            </Card.Body>
            <Card.Body>
                <Switcher
